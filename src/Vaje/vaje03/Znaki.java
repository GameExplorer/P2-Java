...
public class Znaki {
    ...
    static int getChar(char c) {
        ...
        return abeceda.length - 1; //če znaka ni v abecedi vrne presledek
    }
    ...
    public static void main(String[] args) {
        ...
        //7
        System.out.println();
        izpisi64bit(new long[] {0b1111111001000001010000010100000101111110010000000100000011100000L,
                0b0111111101000000100000001000001100001100001100001100000011111111L});
        ...
        System.out.println();
        izpisi64bit(3244141656124426524L);
